...
As you can see with these graphs, diabetes does correlate to an ncrease in risk for MI and stroke, but increasing prevalence of diabetes (all types) does not correlate with an increased risk of stroke nor with MIs.
